...
const MobileAppPage: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-[#121212] min-h-screen transition-colors duration-200">
      ...
      {/* 1. Header Hero */}
      <section className="bg-[#FAF6F3] dark:bg-[#181818] border-b border-[#EDE6DF] dark:border-[#2E2E2E] py-16 md:py-24 px-4 sm:px-6 lg:px-8 transition-colors">
        <div className="max-w-6xl mx-auto text-center space-y-6">
          ...
          <h1 className="text-4xl md:text-6xl font-serif font-bold text-[#1a1a1a] dark:text-[#F5F5F5] tracking-tight">
            Get the Lunar App for iOS & Android
          </h1>

          <p className="text-gray-600 dark:text-[#AAAAAA] text-base md:text-xl max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-[#1a1a1a] dark:bg-[#252525] hover:bg-black dark:hover:bg-[#2e2e2e] text-white px-8 py-4 rounded-xl font-medium text-base transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5 group border border-white/10 cursor-pointer"
            >
            ...
            <a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-white dark:bg-[#1E1E1E] hover:bg-gray-50 dark:hover:bg-[#282828] text-[#1a1a1a] dark:text-[#F5F5F5] border border-[#C1A98F]/50 px-8 py-4 rounded-xl font-medium text-base transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-0.5 group cursor-pointer"
            >
              <Download className="w-5 h-5 text-[#8c6d4f] dark:text-[#C1A98F] group-hover:scale-110 transition-transform" />
              <div className="flex flex-col text-left">
                <span className="text-[10px] text-gray-500 dark:text-[#AAAAAA] uppercase tracking-widest leading-tight">Direct Android Download • v1.2.1</span>
                <span className="font-bold text-base leading-tight text-[#1a1a1a] dark:text-[#F5F5F5]">Download .APK (v1.2.1 Latest)</span>
              </div>
            </a>
          ...
          {/* Quick Notice */}
          <p className="text-xs text-gray-500 dark:text-[#888888] pt-2">
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <div className="text-center mb-10">
          <div className="inline-flex p-1.5 bg-[#FAF7F5] dark:bg-[#1E1E1E] rounded-2xl border border-[#EDE6DF] dark:border-[#2E2E2E] mb-6 transition-colors">
            <button
              onClick={() => setActivePlatformTab('ios')}
              className={`px-6 py-2.5 rounded-xl font-medium text-sm transition-all flex items-center gap-2 cursor-pointer ${
                activePlatformTab === 'ios'
                  ? 'bg-[#1a1a1a] dark:bg-[#C1A98F] text-[#C1A98F] dark:text-[#121212] shadow-sm'
                  : 'text-gray-600 dark:text-[#AAAAAA] hover:text-black dark:hover:text-[#F5F5F5]'
              }`}
            >
          ...
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-[#1a1a1a] dark:text-[#F5F5F5] mb-2">
            {activePlatformTab === 'ios' ? 'How to Install on iPhone' : 'How to Install APK on Android'}
          </h2>
          <p className="text-gray-600 dark:text-[#AAAAAA] max-w-md mx-auto text-sm md:text-base">
            {activePlatformTab === 'ios' 
        ...
        {activePlatformTab === 'ios' && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 animate-fadeIn">
            ...
            {/* Step 1 */}
            <div className="bg-[#FAF7F5] dark:bg-[#1E1E1E] p-6 rounded-2xl border border-[#EDE6DF] dark:border-[#2E2E2E] text-left relative flex flex-col justify-between transition-colors">
              <div>
                <div className="w-10 h-10 rounded-full bg-[#1a1a1a] dark:bg-[#282828] text-[#C1A98F] font-bold flex items-center justify-center text-base mb-5 shadow-sm">
                  1
                </div>
                <h3 className="text-base font-bold text-[#1a1a1a] dark:text-[#F5F5F5] mb-1.5">Open in Safari</h3>
                <p className="text-xs text-gray-600 dark:text-[#AAAAAA] leading-relaxed">
            ...
            <div className="bg-[#FAF7F5] dark:bg-[#1E1E1E] p-6 rounded-2xl border border-[#EDE6DF] dark:border-[#2E2E2E] text-left relative flex flex-col justify-between transition-colors">
              <div>
                ...
                <h3 className="text-base font-bold text-[#1a1a1a] dark:text-[#F5F5F5] mb-1.5 flex items-center gap-1.5">
                  Tap Share
            ...
            <div className="bg-[#FAF7F5] dark:bg-[#1E1E1E] p-6 rounded-2xl border border-[#EDE6DF] dark:border-[#2E2E2E] text-left relative flex flex-col justify-between transition-colors">
              <div>
                ...
                <h3 className="text-base font-bold text-[#1a1a1a] dark:text-[#F5F5F5] mb-1.5 flex items-center gap-1.5">
                  Add to Home Screen
                  <PlusSquare className="w-4 h-4 text-gray-700 dark:text-gray-300" />
                </h3>
                <p className="text-xs text-gray-600 dark:text-[#AAAAAA] leading-relaxed">
            ...
            <div className="bg-[#FAF7F5] dark:bg-[#1E1E1E] p-6 rounded-2xl border border-[#EDE6DF] dark:border-[#2E2E2E] text-left relative flex flex-col justify-between transition-colors">
              <div>
                ...
                <h3 className="text-base font-bold text-[#1a1a1a] dark:text-[#F5F5F5] mb-1.5">Tap Add</h3>
                <p className="text-xs text-gray-600 dark:text-[#AAAAAA] leading-relaxed">
        ...
        {activePlatformTab === 'android' && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 animate-fadeIn">
            ...
            {/* Step 1 */}
            <div className="bg-[#FAF7F5] dark:bg-[#1E1E1E] p-8 rounded-2xl border border-[#EDE6DF] dark:border-[#2E2E2E] text-left relative flex flex-col transition-colors">
              <div className="w-10 h-10 rounded-full bg-[#1a1a1a] dark:bg-[#282828] text-[#C1A98F] font-bold flex items-center justify-center text-lg mb-6 shadow-sm">
                1
              </div>
              <h3 className="text-lg font-bold text-[#1a1a1a] dark:text-[#F5F5F5] mb-2">Download File</h3>
              <p className="text-sm text-gray-600 dark:text-[#AAAAAA] leading-relaxed">
            ...
            <div className="bg-[#FAF7F5] dark:bg-[#1E1E1E] p-8 rounded-2xl border border-[#EDE6DF] dark:border-[#2E2E2E] text-left relative flex flex-col transition-colors">
              ...
              <h3 className="text-lg font-bold text-[#1a1a1a] dark:text-[#F5F5F5] mb-2">Allow Installation</h3>
              <p className="text-sm text-gray-600 dark:text-[#AAAAAA] leading-relaxed">
            ...
            <div className="bg-[#FAF7F5] dark:bg-[#1E1E1E] p-8 rounded-2xl border border-[#EDE6DF] dark:border-[#2E2E2E] text-left relative flex flex-col transition-colors">
              ...
              <h3 className="text-lg font-bold text-[#1a1a1a] dark:text-[#F5F5F5] mb-2">Install & Enjoy</h3>
              <p className="text-sm text-gray-600 dark:text-[#AAAAAA] leading-relaxed">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="text-center mb-12 space-y-2">
          <div className="inline-flex items-center gap-1.5 text-xs text-[#8c6d4f] dark:text-[#C1A98F] font-semibold uppercase tracking-wider">
            <HelpCircle className="w-4 h-4" />
            <span>Got Questions?</span>
          </div>
          <h2 className="text-3xl font-serif font-bold text-[#1a1a1a] dark:text-[#F5F5F5]">Frequently Asked Questions</h2>
        </div>
        ...
        <div className="space-y-4 text-left">
          {faqs.map((faq, idx) => (
            <div
              key={idx}
              className="border border-gray-200 dark:border-[#2E2E2E] rounded-xl overflow-hidden transition-colors"
            >
              <button
                onClick={() => toggleFaq(idx)}
                className="w-full px-6 py-5 text-left flex justify-between items-center bg-[#FAF7F5] dark:bg-[#1E1E1E] hover:bg-gray-100 dark:hover:bg-[#282828] transition-colors cursor-pointer"
              >
                <span className="font-semibold text-sm md:text-base text-[#1a1a1a] dark:text-[#F5F5F5]">{faq.q}</span>
                {openFaq === idx ? (
                  <ChevronUp className="w-5 h-5 text-gray-500 dark:text-[#AAAAAA] shrink-0" />
                ) : (
                  <ChevronDown className="w-5 h-5 text-gray-500 dark:text-[#AAAAAA] shrink-0" />
                )}
              </button>
              {openFaq === idx && (
                <div className="px-6 py-4 text-sm text-gray-600 dark:text-[#AAAAAA] bg-white dark:bg-[#181818] leading-relaxed border-t border-gray-100 dark:border-[#2E2E2E]">
                  {faq.a}
                </div>
              )}
            </div>
      ...
      <div className="bg-[#FAF6F3] dark:bg-[#181818] border-t border-[#EDE6DF] dark:border-[#2E2E2E] py-12 px-4 text-center transition-colors">
        <div className="max-w-md mx-auto space-y-4">
          <h3 className="font-serif text-2xl font-bold text-[#1a1a1a] dark:text-[#F5F5F5]">Ready to experience Lunar on mobile?</h3>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button
              onClick={() => setIsIosModalOpen(true)}
              className="inline-flex items-center justify-center gap-2 bg-[#1a1a1a] dark:bg-[#252525] hover:bg-black dark:hover:bg-[#2e2e2e] text-[#C1A98F] px-6 py-3.5 rounded-full font-bold text-sm transition-colors shadow-md w-full sm:w-auto cursor-pointer"
            >
              <Apple className="w-4 h-4" />
            ...
            <a
              href={downloadApkUrl}
              download="lunar-app.apk"
              className="inline-flex items-center justify-center gap-2 bg-white dark:bg-[#1E1E1E] hover:bg-gray-50 dark:hover:bg-[#282828] text-black dark:text-white border border-gray-300 dark:border-[#2E2E2E] px-6 py-3.5 rounded-full font-bold text-sm transition-colors shadow-sm w-full sm:w-auto cursor-pointer"
            >
              <Download className="w-4 h-4 text-[#8c6d4f] dark:text-[#C1A98F]" />
